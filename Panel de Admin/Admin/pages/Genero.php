...
box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75);  margin-left: 200px;">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="Genero" id="Genero" aria-describedby="emailHelp">
    <small id="sna" class="form-text text-muted">Ingresa el nombre del autor</small>
  </div>
  <input type="submit" style="margin-left:235px;" name="b1" class="btn btn-primary" value="Guardar">
</form>
        </form>
        </div>
        <br><br><br><br><br>
...
<tr>
    ...
    <?php echo '<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#Modal_' . $fila['id_genero'] . '" id=' . $fila['id_genero'] . '" >Editar</button>' ?>
                                ...
                                <fieldset style="width:400px">
                                    <form method="post">
                                        ...
                                        <tr>
                                                ...
                                                <td><input type="text" name="ida" id="ida" value='<?php echo  $fila['id_genero'] ;?>'   readonly="readonly"></td>
                                            </tr>
                                            <tr>
                                                <td><label for="Nombre">Genero:</label></td>
                                                <td><input type="text" name="gen" id="nombre" value='<?php echo  $fila['Genero'] ;?>'></td>
                                            </tr>
                                            </tr>
                                            <tr>
                                                <td>
