...
<head>
  ...
  <title>Estadísticas | Calendario</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="../indexEstadisticas.php" class="d-block">Estadísticas</a>
        </div>
      </div>
            ...
            <div class="sticky-top mb-3">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Draggable Eventos</h4>
                </div>
                <div class="card-body">
                  <!-- the events -->
                  <div id="external-events">
                    <div class="external-event bg-success">Poner ofertas</div>
                    <div class="external-event bg-warning">Actualizar Catálogo</div>
                    <div class="checkbox">
                      <label for="drop-remove">
                        <input type="checkbox" id="drop-remove">
                        remover despues de dropear
                      </label>
                    </div>
                  </div>
                </div>
