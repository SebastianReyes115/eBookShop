...
$e=$_POST['edadautor'];
$na=$_POST['naci'];
$updat="UPDATE autor SET NombreAutor='$n',Nacionalidad='$na',Edad='$e' WHERE id_autor='$idupdate'";
...
if(isset($_POST["b1"]) && !empty($_POST["b1"])) { //Agregar Autor
    ...
    if(!empty($nombre) && !empty($nacio) && !empty($age) && $age>15){
        $sql1="INSERT INTO autor (id_autor,NombreAutor,Nacionalidad,Edad) VALUES ($id,'$nombre','$nacio','$age')";
