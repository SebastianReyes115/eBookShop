...
$listaa="SELECT * FROM autor";
$ejecuta=mysqli_query($con,$listaa);
$contador=1;
while($fila=$ejecuta->fetch_assoc()){
?>
  <input type="checkbox" id="<?php echo $fila['id_usuario']; ?>" name="<?php echo $fila['NombreAutor']; ?>" value="Bike">
    <?php
    echo $fila['NombreAutor'];
    echo "<br>";
}
$con->close();
    ?>
