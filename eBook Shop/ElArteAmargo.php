...
<main>
    ...
    <div class="row"  style="width: 100%;">
        <div class="col-md-4 imagenes" >
            <img  class="tamañoImagen" src="Recursos/img/Amargo.png"/>
        </div>
        <div class="col-md-4 tituloLibro" >
            <h2>El arte de amargarse la vida</h2>

            <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href="" > Paul Watzlawick</a>
            <br>
            <span class="autorEditorial"> EDITORIAL: </span><a class="autorEstilo" href="" >Herder Editorial</a>
        </div>
