...
<main>
    ...
    <div class="row"  style="width: 100%;">
        <div class="col-md-4 imagenes" >
            <img  class="tamañoImagen" src="Recursos/img/IslaWomen.png"/>
        </div>
        <div class="col-md-4 tituloLibro" >
            <h2>Vardo: La isla de las mujeres</h2>

            <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href="" >Kiran Millwood Hargrave</a>
            <br>
            <span class="autorEditorial"> EDITORIAL: </span><a class="autorEstilo" href="" >Ático de los Libros</a>
        </div>
