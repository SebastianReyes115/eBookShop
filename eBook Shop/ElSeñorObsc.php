    ...
    <main>
        ...
        <div class="row" style="width: 100%;">
            <div class="col-md-4 imagenes">
                <img class="tamañoImagen" src="Recursos/img/Elseñorobsc.png" />
            </div>
            <div class="col-md-4 tituloLibro">
                <h2>El Señor de la Obscuridad</h2>

                <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href=""> Kim Richardson</a>
                <br>
                <span class="autorEditorial"> EDITORIAL: </span><a class="autorEstilo" href="">Kim Richardson</a>
            </div>
        ...
        <div>
            <div>
                ...
                <p class="descripcion">
                    Lucifer se ha escapado del purgatorio. La obscuridad desciende en Horizonte y en el mundo mortal. La Orden de los Primeros está en acción, confrontando ángeles contra ángeles. Sus números continúan creciendo y el caos y la destrucción abruman a la Legión.
                </P>
                <br>
                <hr class="separador">
