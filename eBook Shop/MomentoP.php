...
<main>
    ...
    <div>
        <div>
            ...
            <p class="descripcion">
                A partir de una investigación multidisciplinar, en estas páginas obtendremos las respuestas a preguntas tan mundanas –o tan signiﬁcativas– como: ¿cuándo hemos de tomar la primera taza de café?, ¿cuándo deberíamos hacer una pausa en el trabajo?, ¿cuándo hay que empezar una dieta?
            </P>
            <br>
            <hr class="separador">
