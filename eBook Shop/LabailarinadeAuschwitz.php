    ...
    <main>
        ...
        <div class="row" style="width: 100%;">
            <div class="col-md-4 imagenes">
                <img class="tamañoImagen" src="Recursos/img/LaBailarinaAusch.png" />
            </div>
            <div class="col-md-4 tituloLibro">
                <h2>La bailarina de Auschwitz: Una inspiradora historia de valentía y supervivencia</h2>

                <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href=""> Edith Eger</a>
                <br>
