    ...
    <main>
        ...
        <div class="row" style="width: 100%;">
            <div class="col-md-4 imagenes">
                <img class="tamañoImagen" src="Recursos/img/EducaF.png" />
            </div>
            <div class="col-md-4 tituloLibro">
                <h2>Educación financiera</h2>

                <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href=""> Alberto Chan</a>
                <br>
                <span class="autorEditorial"> EDITORIAL: </span><a class="autorEstilo" href="">Plataforma</a>
            </div>
