  ...
  <main>
    ...
    <div class="row" style="width: 100%;">
      <div class="col-md-4" style="padding-left: 130px;">
        <img src="Recursos/img/rabia.png" style="height: 480px; width:380px; padding-left:10px" />
      </div>
      <div class="col-md-4 tituloLibro">
        <h2>Rabia</h2>
        <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href=""> Bob Woodward</a>
        <br>
        <span class="autorEditorial"> EDITORIAL: </span><a class="autorEstilo" href=""> Roca Editorial</a>
      </div>
      <div class="col-md-4 ContenedorPrecio">
        ...
        <div class="add_to_cart">
          ...
          <form action="" method="post">
            ...
            <input type="hidden" name="nombre" id="nombre" value="Rabia">
            <input type="hidden" name="precio" id="precio" value="120">
            <input type="hidden" name="cantidad" id="cantidad" value="1">
            <input type="hidden" name="imagen" id="imagen" value="Recursos/img/rabia.png">
