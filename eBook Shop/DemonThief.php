...
<main>
    ...
    <div class="row"  style="width: 100%;">
        <div class="col-md-4 imagenes" >
            <img  class="tamañoImagen" src="Recursos/img/Demonthief.png"/>
        </div>
        <div class="col-md-4 tituloLibro" >
            <h2>Demon thief</h2>

            <span class="autorEditorial"> AUTOR: </span><a class="autorEstilo" href="" > Darren Shan</a>
            <br>
            <span class="autorEditorial"> EDITORIAL: </span><a class="autorEstilo" href="" > Little, Brown Books for Young readers</a>
        </div>
    ...
    <div>
        <div>
            ...
            <p class="descripcion">
                Kernel Fleck siempre ha sabido que es raro. Ve luces. Extrañas manchas de luz multicolores, arremolinándose en el aire. Pero no es hasta que se abre una ventana a un mundo de demonios, con horribles consecuencias, que Kernel descubre sus poderes. Como discípulo, su misión es cazar demonios viciosos y poderosos hasta la muerte.
            </P>
            <br>
            <hr class="separador">
